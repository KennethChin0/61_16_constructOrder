...
public class OrderedList_inArraySlots
     ...
     */
     private int champIndex( ArrayList<Integer> challengers) {
       ...
       while (challengers.get(smallestNumber) == null) {
         smallestNumber ++;
       }
       for (int i = smallestNumber + 1; i < challengers.size() ; i++ ) {

            if (challengers.get(i) != null && (challengers.get(i) < challengers.get(smallestNumber))) {
              smallestNumber = i;
            }
            }
        return smallestNumber;  // replace this line
     }
